        ...
        private MenuViewModel Menu = new MenuViewModel
        {
           Modules = new List<ModuleViewModel>
           {
                ...
                new ModuleViewModel
                {
                    ...
                    Pages = new List<ModulePageViewModel>
                    {
                         new ModulePageViewModel{AspRouteContainer = null, PageName = "Search RT Numbers" },
                         new ModulePageViewModel{AspRouteContainer = "addUpdateRTNumberContainer", PageName = "Add  RT Number" },
                    }
                },
                     new ModuleViewModel
                {
